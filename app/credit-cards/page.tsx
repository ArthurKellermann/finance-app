...
const CreditCardsPage = async () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <CardHeader className="flex flex-row items-center justify-between rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 p-6 text-white">
        <div>
      ...
      <div className="p-6">
        {creditCards.length > 0 ? (
          <div className="grid w-auto grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          ...
          <div className="flex flex-col items-center justify-center rounded-lg bg-gray-50 py-16 text-center">
            ...
            <p className="max-w-md text-sm text-gray-400">
              Adicione seus cartões de crédito para monitorar gastos e gerenciar
              faturas
            </p>
            <div className="mt-6">
              <AddCreditCardButton userCanAddCreditCard={true} />
